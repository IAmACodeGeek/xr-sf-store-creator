...
export const CreatorKit = () => {
      ...
      >
        <Button
          sx={{
            ...
            borderStyle: entityType === "PRODUCT" ? "none" : "solid",
            borderRadius: "0",
            "&:hover": {
              backgroundColor:
                entityType === "PRODUCT"
        ...
        <Button
          sx={{
            ...
            borderWidth: "2px",
            borderColor: "rgb(77, 177, 255)",
            borderStyle: entityType === "ASSET" ? "none" : "solid",
            borderRadius: "0",
            "&:hover": {
              backgroundColor:
                entityType === "ASSET"
      ...
      >
        <Button
          sx={{
            ...
            borderWidth: "2px",
            borderColor: "rgb(77, 177, 255)",
            borderStyle: paramsType === "CUSTOM" ? "none" : "solid",
            borderRadius: "0",
            "&:hover": {
              backgroundColor:
                paramsType === "CUSTOM"
        ...
        <Button
          sx={{
            ...
            borderWidth: "2px",
            borderColor: "rgb(77, 177, 255)",
            borderStyle: paramsType === "PLACEHOLDER" ? "none" : "solid",
            borderRadius: "0",
            "&:hover": {
              backgroundColor:
                paramsType === "PLACEHOLDER"
          ...
          <Box sx={{ display: "flex", gap: "10px" }}>
            {faceOptions.map((opt) => (
              <Button
                key={opt.value}
                variant={
                  envProduct.face === opt.value ? "contained" : "outlined"
                }
                sx={{
                  minWidth: "60px",
                  color: "white",
                  background:
                    envProduct.face === opt.value
                      ? "linear-gradient(135deg, #8458FB, #6A6CEC, #4D82DC, #3098CB, #17ABBD)"
                      : "rgba(77, 177, 255, 0.1)",
                  border:
                    envProduct.face === opt.value
      ...
      >
        <Button
          sx={{
            ...
            borderWidth: "2px",
            borderColor: "rgb(77, 177, 255)",
            borderStyle: assetSource === "LIBRARY" ? "none" : "solid",
            borderRadius: "0",
            "&:hover": {
              backgroundColor:
                assetSource === "LIBRARY"
        ...
        <Button
          sx={{
            ...
            borderWidth: "2px",
            borderColor: "rgb(77, 177, 255)",
            borderStyle: assetSource === "OWN" ? "none" : "solid",
            borderRadius: "0",
            "&:hover": {
              backgroundColor:
                assetSource === "OWN"
  ...
  const FileSelector = () => {
    ...
    const handleDrop = async (event: React.DragEvent<HTMLDivElement>) => {
      ...
      await AssetService.uploadAssetFiles(
        ...
        validFiles,
        Object.values(envAssets).filter(
          (envAsset) => envAsset.isEnvironmentAsset && envAsset.source === "OWN"
        ).length
      ).then((result) => {
    ...
    return (
      !activeAssetId && (
        <Box
          ...
          className="AssetList"
        >
          {Object.values(envAssets)
            .filter((envAsset) => envAsset.source === assetSource)
            .map((envAsset: EnvAsset) => {
  ...
  return (
    ...
    >
      ...
      {entityType === "ASSET" && assetSource === "OWN" && !activeAssetId && (
        <FileSelector />
      )}
